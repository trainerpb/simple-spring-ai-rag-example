...
import home.soham.tools.docs.ai.service.tool.InsuranceTool;
...
public class RagService {
    ...
    private final InsuranceTool insuranceTool;
    @Value("classpath:/prompt/rag-prompt.st")
    private Resource promptResource;

    public RagService(ChatClient.Builder chatClientBuilder, VectorStore vectorStore, InsuranceTool insuranceTool) {
        this.insuranceTool = insuranceTool;
    ...
    public Flux<String> retrieveAndGenerateStreaming(String msg) {
        ...
        return Mono.fromCallable(() -> {
            ...
            var prompt = new Prompt(List.of(systemPromptTemplate.createMessage(Map.of("information", informationAsString)), new UserMessage(msg)));
    ...
    public Flux<String> queryDatabaseAndAnswerInsuranceDetails(String msg) {

        return Mono.fromCallable(() -> {
        return chatClient.prompt().user(msg).tools(insuranceTool)
